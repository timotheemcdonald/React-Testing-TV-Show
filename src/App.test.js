...
console.log(fetchShow, 'this is mockFetchShow')

test('Render the episodes to the page when data fetch finishes', async () => {
...
const episodesArr = await screen.findAllByTestId(/episodes/i)
expect(episodesArr).toHaveLength(8)
